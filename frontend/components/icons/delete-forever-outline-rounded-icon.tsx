...
type DeleteForeverOutlineRoundedIconProps = {
  size?: number;
  color?: string;
  strokeWidth?: number;
  background?: string;
...
const DeleteForeverOutlineRoundedIcon = ({
  size = undefined,
  color = "#000000",
  strokeWidth = 2,
  ...
  flipVertical = false,
  padding = 0,
}: DeleteForeverOutlineRoundedIconProps) => {
  const transforms = [];
...
export default DeleteForeverOutlineRoundedIcon;
